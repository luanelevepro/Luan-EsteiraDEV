...
<span className='text-[11px] font-black tracking-tight text-blue-700 dark:text-blue-300 uppercase'>
        ...
        <div className="flex items-center gap-1.5 mb-2">
          {epiTag && (
            <span className="text-[9px] font-bold text-white bg-muted-foreground px-2 py-0.5 rounded uppercase">
              EPI
            </span>
          )}
          {ajudanteTag && (
			...
			{(() => {
				...
				if (isCargaEntregue) {
					...
					const deliveryDate = deliveryDateTime.toLocaleDateString('pt-BR', { day: '2-digit', month: '2-digit' });
					const deliveryTime = deliveryDateTime.toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' });
