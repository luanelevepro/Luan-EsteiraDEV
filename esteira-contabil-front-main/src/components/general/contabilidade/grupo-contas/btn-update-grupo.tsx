...
export default function HandleUpdateGrupo({ children, onChange, data }: HandleInsertGrupoProps) {
			...
			<Dialog open={open} onOpenChange={setOpen}>
				...
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>Insira os dados do grupo.</DialogDescription>
					</DialogHeader>
					...
					<form onSubmit={handleSubmit} className='grid gap-4'>
						...
						<Button type='submit' disabled={isLoading} className='w-full'>
							{isLoading ? 'Atualizando...' : 'Atualizar Grupo de Contas'}
