...
import BtnSetModulosEmpresa from '../empresas/btn-modules-empresa';
import BtnHandleInsertAPI from './btn-insert-api-url';
import BtnDeleteEscritorio from './btn-handle-delete';
import BtnVincularParametros from '../empresas/btn-vincular-parametros';
		...
		cell: ({ row }) => {
			return (
				<div className='flex justify-end'>
					...
					<BtnDeleteEscritorio empresa={row.original} />
