...
function SelectTrigger({
	...
	return (
		<SelectPrimitive.Trigger
			// make trigger a group so child svg can react to aria-expanded via group-aria-
		...
		>
			...
			<SelectPrimitive.Icon asChild>
				{/* use group-aria so child can react to trigger's aria-expanded */}
				<ChevronDownIcon className='size-4 opacity-50 transition-transform duration-200 group-aria-[expanded=true]:rotate-180 data-[state=open]:rotate-180' />
