...
function TooltipContent({ className, contrast, sideOffset = 0, children, ...props }: TooltipContentProps) {
	return (
		<TooltipPrimitive.Portal>
			...
			>
				...
				<TooltipPrimitive.Arrow
					className={cn(
						'z-50 size-2.5 translate-y-[calc(-50%_-_0px)] rotate-45 rounded-[2px] border-r border-b',
						contrast ? 'bg-card text-primary-foreground fill-card' : 'bg-primary fill-primary',
					)}
				/>
			</TooltipPrimitive.Content>
		</TooltipPrimitive.Portal>
